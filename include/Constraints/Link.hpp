...
class Link : public Constraint {
   ...
   public:
    Link(std::shared_ptr<phy::Corpse> corpse_a = nullptr, std::shared_ptr<phy::Corpse> corpse_b = nullptr, gmt::VectorI relative_pos_a = gmt::VectorI(), gmt::VectorI relative_pos_b = gmt::VectorI(), gmt::UnitI relative_angle_a = gmt::UnitI(), gmt::UnitI relative_angle_b = gmt::UnitI(),
